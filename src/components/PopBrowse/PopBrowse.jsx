...
import { fetchGetTask } from "../../services/api";
...
function PopBrowse() {
  ...
  const getTask = useCallback(async () => {
    ...
    setError("");
    try {
      const data = await fetchGetTask({ token, id });
      setTask(data.task);
    } catch (err) {
          ...
          <div className="pop-browse__block">
            <div className="pop-browse__content">
              <div className="pop-browse__top-block">
                ...
                <div
                  className={`categories__theme theme-top _${getThemeColor(task.topic)} _active-category`}
                >
                  <p className={`_${getThemeColor(task.topic)}`}>
                    {task.topic}
                  </p>
                </div>
              </div>
